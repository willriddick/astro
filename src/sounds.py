...
SOUNDS.load_sounds([
    ...
    Sound("hurt", default_volume=0.4),
    Sound("dead", default_volume=2.5),
    Sound("blip_pitch",  path="blip2", default_volume=0.8, pitch=[0.7, 1.2, 0.03]),
    Sound("blip", path="blip2", default_volume=0.8, pitch=[0.9, 1.1, 0.025]),
